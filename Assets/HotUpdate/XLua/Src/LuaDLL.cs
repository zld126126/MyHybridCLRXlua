...
namespace XLua.LuaDLL
{
	...
	public partial class Lua
	{
		...
		{
			return XLuaBase.Lua.lua_gc(L, (int) what, data);
		}
		...
		{
			return XLuaBase.Lua.lua_settop(L, stackPos);
		}

		public static int lua_insert(IntPtr L, int stackPos)
		{
			return XLuaBase.Lua.lua_insert(L, stackPos);
		}

		public static int lua_remove(IntPtr L, int stackPos)
		{
			return XLuaBase.Lua.lua_remove(L, stackPos);
		}
		...
		{
			return XLuaBase.Lua.lua_rawset(L, stackPos);
		}
		...
		{
			return XLuaBase.Lua.luaL_unref(L, stackPos, r);
		}
...
return XLuaBase.Lua.lua_pushstring(L, str);
		...
		public static void xlua_set_csharp_wrapper_caller(IntPtr wrapper)
		{
			XLuaBase.Lua.xlua_set_csharp_wrapper_caller(wrapper);
		}

		public static void xlua_push_csharp_wrapper(IntPtr L, int wrapperID)
		{
			XLuaBase.Lua.xlua_push_csharp_wrapper(L, wrapperID);
		}
				[AOT.MonoPInvokeCallback(typeof(CSharpWrapperCaller))]
