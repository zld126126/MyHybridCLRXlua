...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysicsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 39, 20, 19);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "ContactEvent", _e_ContactEvent);
        ...
        static int _m_BakeMesh_xlua_st_(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Physics.BakeMesh!");
        ...
        static int _g_get_simulationMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, UnityEngine.Physics.simulationMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_invokeCollisionCallbacks(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushboolean(L, UnityEngine.Physics.invokeCollisionCallbacks);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_simulationMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			UnityEngine.SimulationMode gen_value;translator.Get(L, 1, out gen_value);
				UnityEngine.Physics.simulationMode = gen_value;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_invokeCollisionCallbacks(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_ContactEvent(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                UnityEngine.Physics.ContactEventDelegate gen_delegate = translator.GetDelegate<UnityEngine.Physics.ContactEventDelegate>(L, 2);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#2 need UnityEngine.Physics.ContactEventDelegate!");
                }
                
				
				if (gen_param_count == 2 && LuaAPI.xlua_is_eq_str(L, 1, "+")) {
					UnityEngine.Physics.ContactEvent += gen_delegate;
					return 0;
				} 
			...
			return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Physics.ContactEvent!");
        }
