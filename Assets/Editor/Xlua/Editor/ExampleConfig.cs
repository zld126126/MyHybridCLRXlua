...
public static class ExampleConfig
{
    ...
    public static List<Type> LuaCallCSharp = new List<Type>() {
        ...
        typeof(GameMain.Scripts.Performance.PerformanceSetting),
        typeof(GameMain.Scripts.Performance.Performance),
        typeof(HotFix.Performance.Performance),
        typeof(HotFix.Utils.Monitor),
        typeof(HotFix.Utils.Fps),
        typeof(HotFix.Utils.LuaEnvUtil),
        typeof(HotFix.Utils.LuaCache),
        typeof(SRDebugerWrap),
    };
